...
export const getMovies = (year, category) => {
    return (dispatch) => {
      ...
      return axios.get('https://api.themoviedb.org/3/discover/movie?primary_release_year='  + year + '&api_key=' + mykey +'&sort_by=' + category + '.desc&language=en-US&certification_country=US&external_source=twitter_id')
